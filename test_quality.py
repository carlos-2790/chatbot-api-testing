...
def main():
    ...
    print_score("Structural Score", scores['structural_score'], scores['weights']['structural'], "🏗️")
    ...
    print(f"  {'✅' if details['has_code_examples'] else '❌'} Has code examples: {details['has_code_examples']}")
    print(f"  🔤 Keyword count: {details['keyword_count']}")
    print(f"  🛠️  Frameworks mentioned: {details['frameworks_mentioned']}")
    print(f"  {'✅' if details['has_structure'] else '❌'} Has structure: {details['has_structure']}")
